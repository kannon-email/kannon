...
var (
	statsApiV1ServiceDescriptor                  = apiv1.File_kannon_stats_apiv1_statsapiv1_proto.Services().ByName("StatsApiV1")
	statsApiV1GetStatsMethodDescriptor           = statsApiV1ServiceDescriptor.Methods().ByName("GetStats")
	statsApiV1GetStatsAggregatedMethodDescriptor = statsApiV1ServiceDescriptor.Methods().ByName("GetStatsAggregated")
)
...
func NewStatsApiV1Client(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) StatsApiV1Client {
	...
	return &statsApiV1Client{
		getStats: connect.NewClient[apiv1.GetStatsReq, apiv1.GetStatsRes](
			...
			connect.WithSchema(statsApiV1GetStatsMethodDescriptor),
		...
		getStatsAggregated: connect.NewClient[apiv1.GetStatsAggregatedReq, apiv1.GetStatsAggregatedRes](
			...
			connect.WithSchema(statsApiV1GetStatsAggregatedMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
