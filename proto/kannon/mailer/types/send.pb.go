...
func file_kannon_mailer_types_send_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_kannon_mailer_types_send_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Sender); i {
			case 0:
				return &v.state
			case 1:
		...
		file_kannon_mailer_types_send_proto_msgTypes[1].Exporter = func(v any, i int) any {
