...
func file_kannon_mailer_apiv1_mailerapiv1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_kannon_mailer_apiv1_mailerapiv1_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_kannon_mailer_apiv1_mailerapiv1_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_kannon_mailer_apiv1_mailerapiv1_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_kannon_mailer_apiv1_mailerapiv1_proto_msgTypes[3].Exporter = func(v any, i int) any {
