...
func (_m *Publisher) Publish(subj string, data []byte) error {
...
//   - subj string
//   - data []byte
func (_e *Publisher_Expecter) Publish(subj interface{}, data interface{}) *Publisher_Publish_Call {
	return &Publisher_Publish_Call{Call: _e.mock.On("Publish", subj, data)}
}

func (_c *Publisher_Publish_Call) Run(run func(subj string, data []byte)) *Publisher_Publish_Call {
